...
class Wordlevel:
    ...
    def prepareModel(self):
        ...
        model = Sequential()
        model.add(LSTM(300, return_sequences= True, input_shape=(self.X.shape[1], self.X.shape[2])))
    ...
    def prepareData(self, List):
        ...
        self.X = np.reshape(self.dataX, (len(trainingdata), 100, 1))
        # normalize
    ...
    def train(self):
        ...
        # fit the model
        model.fit(self.X, self.y, epochs=200, batch_size=64, callbacks=callbacks_list, validation_split=0.15)
        model.save("c13.h5")
    ...
    def main(self):
        ...
        allScripts = allScripts[0:20]  # Limit the number of episodes
        ...
        #weights50 = "weights-improvement-5episodes-673-0.4354.hdf5"
        ...
        #seed = "[Scene: Central Perk, Chandler, Joey, Phoebe, and Monica are there.] Monica: Theres nothing to tell! Hes just some guy I work with! Joey: Cmon, youre going out with the guy! Theres gotta be something wrong with him!"
        #self.test(seed)
