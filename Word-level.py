...
class Wordlevel:
    ...
    def prepareModel(self):
        ...
        model = Sequential()
        model.add(LSTM(300, input_shape=(self.X.shape[1], self.X.shape[2])))
    ...
    def train(self):
        ...
        # fit the model
        model.fit(self.X, self.y, epochs=10, batch_size=32, callbacks=callbacks_list, validation_split=0.15)
        model.save("c13.h5")
